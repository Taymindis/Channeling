...
public class ChannelingProxySSLHandler implements ErrorCallback {
    ...
    ChannelingProxySSLHandler(ChannelingSocket socket, ChannelingProxy channelingProxy) {
    ...
    protected void connectThen(ChannelingSocket channelingSocket) {
        ...
        ((ChannelProxySSLRunner) channelingSocket).proxyConnectWrite(establishedBuffer, this::establishExternalThen);
    ...
    protected void establishExternalThen(ChannelingSocket channelingSocket) {
        ...
        ((ChannelProxySSLRunner) channelingSocket).proxyConnectRead(establishedBuffer, this::readStatusFromExternalThen);
    }
